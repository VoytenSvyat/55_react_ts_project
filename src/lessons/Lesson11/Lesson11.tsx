...
function Lesson11() {
    ...
    // Mounting - пример использования useEffect, для виполенния действия при первом рендере компонента
    // useEffect(()=>{
    //     console.log('Mounting(first render)');
    // }, []);

    useEffect(()=>{setIsFirstRender(false)}, [])
    // Updating - пример использования UseEffect, при изменении компонента
    useEffect(()=> {
        if(!isFirstRender){
    ...
    // Example ДЗ
    // useEffect(()=>{
    // изменять 3-й state, которий хранит значение количества изменений
    // setState...
    // },[exampleValue])
    // 
  return (
